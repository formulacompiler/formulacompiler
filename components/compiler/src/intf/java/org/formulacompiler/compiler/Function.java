...
public enum Function {
	...
	ABS, ACOS, ASIN, ATAN, ATAN2, ACOSH, ASINH, ATANH, COS, COSH, GEOMEAN, SIN, TAN, DEGREES, RADIANS, PI, CEILING, FLOOR, MROUND, ROUND, ROUNDDOWN, ROUNDUP, TRUNC, EVEN, ODD, INT, EXP, POWER, LN, LOG, LOG10, MOD, SQRT, HARMEAN, PERMUT, SINH, TANH, SIGN,
	...
	STDEVPA, SUMPRODUCT, SUMX2MY2, SUMX2PY2, SUMXMY2, VARA, STEYX, CORREL, INTERCEPT, SLOPE, FORECAST, PROB,
	CRITBINOM, LARGE, MEDIAN, MODE, PERCENTILE, PERCENTRANK, QUARTILE, SMALL, TRIMMEAN,

	// Dates

	DATE, TIME, SECOND, MINUTE, HOUR, WEEKDAY, DAY, MONTH, YEAR, YEARFRAC, DAYS360, WORKDAY, EOMONTH, EDATE,
