	...
	private static void append( StringBuilder _stringBuilder, ExpressionNode _expr, CellIndex _baseCell, Operator _context )
	{
		if (_expr instanceof ExpressionNodeForConstantValue) {
			...
			if (constantValue instanceof Boolean) {
				...
				_stringBuilder.append( constantValue );
			}
		}
		...
		else if (_expr instanceof ExpressionNodeForRangeShape) {
			final ExpressionNodeForRangeShape expressionNodeForRangeShape = (ExpressionNodeForRangeShape) _expr;
			append( _stringBuilder, expressionNodeForRangeShape.argument( 0 ), _baseCell, _context );
		}
