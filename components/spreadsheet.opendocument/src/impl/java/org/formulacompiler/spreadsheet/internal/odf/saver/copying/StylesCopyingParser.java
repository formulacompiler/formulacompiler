 ...
 */
public class StylesCopyingParser extends CopyingParser
{
	private final Set<Style> styles;

	public StylesCopyingParser( final Set<Style> _styles )
	{
		this.styles = _styles;
	}
	...
	{
		return Collections.singletonMap( XMLConstants.Office.STYLES, new StylesCopyingHandler( _writer, this.styles ) );
	}
}