...
public class LoadSaveTest extends AbstractVerifyingTestCase
{
	...
	public void testDataTypes()
	{
		...
		assertEquals( new Duration( (23.0 + (12.0 + 23.0 / 60.0) / 60.0) / 24.0 ), rows[ 6 ].getCells()[ 1 ].getConstantValue() );
	}
	...
	public void testRangeNames()
	{
		...
		final Spreadsheet.Range rangeS1B2S3C4 = definedNames.get( "Range_Sheet1B2Sheet3C4" );
		assertEquals( "Sheet1!B2", rangeS1B2S3C4.getTopLeft().toString() );
		assertEquals( "Sheet3!C4", rangeS1B2S3C4.getBottomRight().toString() );
