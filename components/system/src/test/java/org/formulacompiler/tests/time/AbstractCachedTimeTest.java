...
public abstract class AbstractCachedTimeTest extends AbstractTimeTest
{
	public AbstractCachedTimeTest( String _name, NumericType _numericType )
	{
		super( _name, _numericType, ResettableOutputs.class );
	}
